...
<?php
	...
	$sql_BOM="select EstimateBOMId, EstimateId, ITEMNMBR, CAST(ITEMDESC as varchar(30)) as ITEMDESC, CAST(ROUND(QTY,2) as Decimal(18,2)) as QTY, Noninventory, UofM, Note, (select count(*) from  DUREX_EstimateBOM where EstimateId=1004 and ParentEstimateBOMId=b.EstimateBOMId) as Children from DUREX_EstimateBOM b where EstimateId=".$_REQUEST["estimate"]." and ParentEstimateBOMId=0";
...
?>
	<table class="table table-striped" style="margin-top: 5px;background-color:#ffffff;" id="mytable">
		<tr>
			...
			<th style="column-width:27px;"><br></th>
	...
	<tbody id="component<?php print $bomid; ?>">
		<tr>
			...
			<td style="width: 20px; padding:0px;">
				...
				if ($children==1) {
				?>
				<a onclick="getchildbom(<?php print "$estimateid, $bomid, $bomline"; ?>); "><img id="bom_childIndicator<?php print $bomid; ?>" src="images/plus.png" width="30" height="30" ></a>
				<?php 
					}
				?>
			</td>			
			<td style="column-width:40px;text-align: right"><?php print $bomline; ?></td>
