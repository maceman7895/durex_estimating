...
<?php
	...
	foreach($db->query($sql_estimate) as $estimate) {
			...
			if ($estimate["Commission"]=='') {
				...
				$estCommission=$estimate["Commission"];
			}
	...
	<body>
		...
		<div style="padding:10px;">
			<form class="needs-validation" novalidate>
			  ...
			  <div class="form-row">
				...
				<div class="form-group col-md-2">
					...
					<input type="estimator" class="form-control"  <?php if ($claimedestimate==1) { print 'style="background: #79f2e4;"'; } ?> id="estimator" name="estimator" value="<?php print $estEstimator; ?>" readonly>
				</div>
				<div class="form-group col-md-1">
				...
				<div class="form-group col-md-2">
					...
					<select class="form-control" id="status">
					  <option value=""> </option>
					  <option value="Aprove"><img src="image/edit.png">Approved</option>
			  ...
			  <div class="form-row">
				...
				<div class="form-group col-sm-1">
					...
					<input type="text" class="form-control" id="qty1" value="<?php print $quantity[0]; ?>" readonly>
				</div>
				<div class="form-group col-md-1">
					<label for="qty2">QTY 2:</label>
					<input type="text" class="form-control" id="qyt2" value="<?php print $quantity[1]; ?>" disabled>
				</div>
				<div class="form-group col-md-1">
			  ...
			  <div class="form-row">
				...
				<div class="form-group col-md-2" style="text-align:center;">
				  ...
				  <input type="checkbox" class="form-control" id="drawing"<?php if ($estApprovedDrawings==1) { print " checked"; } ?> disabled>
				</div>
				<div class="form-group col-sm-1" style="text-align:center;">
				  <label for="pqa">PQA Required</label>
				  <input type="checkbox" class="form-control" id="pqa"<?php if ($estPQA==1) { print " checked"; } ?> disabled>
				</div>
				<div class="form-group col-sm-1" style="text-align:center;">
				  <label for="ready">Ready for Approval</label>
				  <input type="checkbox" class="form-control" id="ready"<?php if ($estReady==1) { print " checked"; } ?> disabled>
				</div>
			  </div>
			...
			<ul class="nav nav-tabs" id="myTabs" role="tablist">
			  ...
			  <li class="nav-item">
				<a class="nav-link" id="bom-tab" href="#bom" role="tab" data-url="bom2.php" data-parms="estimate=<?php print $estNumber; ?>">BOM</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" id="mocharge-tab" data-toggle="tab" href="#mocharge" role="tab" aria-controls="mocharge" aria-selected="false">MO Charge</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" id="routing-tab" href="#routing" role="tab" data-url="routing.php" data-parms="estimate=<?php print $estNumber; ?>">Routing</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" id="miscoss-tab" data-toggle="tab" href="#miscoss" role="tab" data-url="misccharges.php" data-parms="estimate=<?php print $estNumber; ?>&costtype=MISC">Misc./OSS</a>
			  </li>
			  <li class="nav-item">
			...
			<div class="tab-content" id="myTabContent">
			  ...
			  <div class="tab-pane fade" id="bom" role="tabpanel" aria-labelledby="bom-tab"></div>
			  <div class="tab-pane fade" id="mocharge" role="tabpanel" aria-labelledby="mocharge-tab">
				<div class="form-group col-md-1">
					<label for="mocharge">MO Charge:</label>
					<input type="number" class="form-control" id="mochargeamt" value="<?php print $estMOCharge; ?>" readonly>
				</div>
			  </div>
			  <div class="tab-pane fade" id="routing" role="tabpanel" aria-labelledby="routing-tab"></div>
			  <div class="tab-pane fade" id="miscoss" role="tabpanel" aria-labelledby="miscoss-tab">Miscellaneous & OSS</div>
			  <div class="tab-pane fade" id="tooling" role="tabpanel" aria-labelledby="tooling-tab">Tooling</div>
			  <div class="tab-pane fade" id="engineering" role="tabpanel" aria-labelledby="engineering-tab" style="padding:10px;">
				<div class="form-row">
					<div class="form-group col-md-1">
						<label for="nrecharge">NRE Charge:</label>
						<input type="number" class="form-control" id="nrecharge" value="<?php print $estNRECharge; ?>">
					</div>	
					<div class="form-group form-check" style="margin: 5px";>
					  <input class="form-check-input" type="radio" name="nretypeRadios" id="nreamortize" value="Amortize"<?php if ($estNREChargeType=="Amortize") { print " checked"; } ?> ReadOnly>
					  <label class="form-check-label" for="nreamortize">
						Amortize
					  </label>
					</div>
					<div class="form-group form-check" style="margin: 5px";>
					  <input class="form-check-input" type="radio" name="nretypeRadios" id="Lot" value="Lot Charge"<?php if ($estNREChargeType=="Lot Charge") { print " checked"; } ?> ReadOnly>
			  ...
			  <div class="tab-pane fade" id="pricing" role="tabpanel" aria-labelledby="pricing-tab">Pricing</div>
			</div>
		</div>
		  ...
		  <div class="modal-dialog modal-lg" style="display:table;">
			<div class="modal-content">
			  <div class="modal-header">
			  	<h4 class="modal-title">Modal title 2</h4><span>modal-2</span>
		...
		<div class="modal fade" id="modal-1" role="dialog">
		  <div class="modal-dialog modal-lg">
			<div class="modal-content">
			  <div class="modal-header">
			  	<h4 class="modal-title">Modal title 1</h4><span>modal-1</span>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  </div>
			  <div class="modal-body">
				<p>Houston, the modal content didn't load!</p>
...
<?php 
	include "footer.php";
?>
	<script src="js/approveestimate.js"></script>